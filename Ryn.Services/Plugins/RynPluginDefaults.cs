...
namespace Ryn.Services.Plugins
{
    /// <summary>
    /// Represents default values related to plugins
    /// </summary>
    public static partial class RynPluginDefaults
    {
        /// <summary>
        ...
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new("Ryn.plugins.adminnavigation.{0}", AdminNavigationPluginsPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefix => "Ryn.plugins.adminnavigation.";
    }
}