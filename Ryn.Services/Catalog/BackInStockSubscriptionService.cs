...
namespace Ryn.Services.Catalog
{
    ...
    public partial class BackInStockSubscriptionService : IBackInStockSubscriptionService
    {
        ...
        public virtual async Task<int> SendNotificationsToSubscribersAsync(Product product)
        {
            ...
            {
                var customerLanguageId = await _genericAttributeService.GetAttributeAsync<Customer, int>(subscription.CustomerId, RynCustomerDefaults.LanguageIdAttribute, subscription.StoreId);
