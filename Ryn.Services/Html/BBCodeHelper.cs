...
using Ryn.Services.Html.CodeFormatter;

namespace Ryn.Services.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper : IBBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.RynCommerce.com]my site[/url]
                // becomes: <a href="https://www.RynCommerce.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.RynCommerce.com[/url]
                // becomes: <a href="https://www.RynCommerce.com">https://www.RynCommerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.RynCommerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.RynCommerce.com/Content/Images/Image.jpg">
