...
namespace Ryn.Services.Authentication
{
    ...
    /// </summary>
    public static partial class RynAuthenticationDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string ClaimsIssuer => "rynCommerce";
        ...
        /// </summary>
        public static string ExternalAuthenticationErrorsSessionKey => "Ryn.externalauth.errors";
    }
}