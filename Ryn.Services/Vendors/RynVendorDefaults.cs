...
namespace Ryn.Services.Vendors
{
    /// <summary>
    /// Represents default values related to vendor services
    /// </summary>
    public static partial class RynVendorDefaults
    {
        /// <summary>
        ...
        /// </remarks>
        public static CacheKey VendorAttributeValuesByAttributeCacheKey => new("Ryn.vendorattributevalue.byattribute.{0}");
