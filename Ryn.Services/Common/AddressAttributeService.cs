...
namespace Ryn.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(RynCommonDefaults.AddressAttributeValuesByAttributeCacheKey, addressAttributeId);
