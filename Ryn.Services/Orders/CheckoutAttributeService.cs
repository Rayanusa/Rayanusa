...
namespace Ryn.Services.Orders
{
    ...
    public partial class CheckoutAttributeService : ICheckoutAttributeService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(RynOrderDefaults.CheckoutAttributesAllCacheKey, storeId, excludeShippableAttributes);
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(RynOrderDefaults.CheckoutAttributeValuesAllCacheKey, checkoutAttributeId);
