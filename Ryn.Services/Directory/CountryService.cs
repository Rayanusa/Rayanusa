...
namespace Ryn.Services.Directory
{
    /// <summary>
    /// Country service
    /// </summary>
    public partial class CountryService : ICountryService
    {
        ...
        public virtual async Task<IList<Country>> GetAllCountriesAsync(int languageId = 0, bool showHidden = false)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(RynDirectoryDefaults.CountriesAllCacheKey, languageId,
                showHidden, store);
        ...
        public virtual async Task<Country> GetCountryByTwoLetterIsoCodeAsync(string twoLetterIsoCode)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(RynDirectoryDefaults.CountriesByTwoLetterCodeCacheKey, twoLetterIsoCode);
        ...
        public virtual async Task<Country> GetCountryByThreeLetterIsoCodeAsync(string threeLetterIsoCode)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(RynDirectoryDefaults.CountriesByThreeLetterCodeCacheKey, threeLetterIsoCode);
