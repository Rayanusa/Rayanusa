...
namespace Ryn.Services.Media
{
    /// <summary>
    /// Represents default values related to media services
    /// </summary>
    public static partial class RynMediaDefaults
    {
        /// <summary>
        ...
        /// {0} : thumb file name
        /// </remarks>
        public static CacheKey ThumbExistsCacheKey => new("Ryn.azure.thumb.exists.{0}", ThumbsExistsPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string ThumbsExistsPrefix => "Ryn.azure.thumb.exists.";
