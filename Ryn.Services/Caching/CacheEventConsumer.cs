...
namespace Ryn.Services.Caching
{
    /// <summary>
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(RynEntityCacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(RynEntityCacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(RynEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
