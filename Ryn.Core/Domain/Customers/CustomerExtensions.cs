...
namespace Ryn.Core.Domain.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(RynCustomerDefaults.SearchEngineCustomerName, StringComparison.InvariantCultureIgnoreCase);
        ...
        public static bool IsBackgroundTaskAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(RynCustomerDefaults.BackgroundTaskCustomerName, StringComparison.InvariantCultureIgnoreCase);
