...
namespace Ryn.Core.Domain
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by RynCommerce" text should be displayed.
        /// Please find more info at https://www.Ryncommerce.com/Ryncommerce-copyright-removal-key
        /// </summary>
        public bool HidePoweredByRynCommerce { get; set; }
