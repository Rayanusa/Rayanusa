...
{
    /// <summary>
    /// Represents Ryn engine
    /// </summary>
    public class RynEngine : IEngine
    {
        #region Utilities
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var typeFinder = Singleton<ITypeFinder>.Instance;
            var startupConfigurations = typeFinder.FindClassesOfType<IRynStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IRynStartup)Activator.CreateInstance(startup))
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new RynException("Unknown dependency");
                        return service;
                    });
            ...
            throw new RynException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
