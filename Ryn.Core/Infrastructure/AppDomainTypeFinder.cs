...
{
    /// <summary>
    /// A class that finds types needed by Ryn by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IRynFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(IRynFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Ryn.
        /// </returns>
        ...
        /// <summary>Gets or sets whether Ryn should iterate assemblies in the app domain when loading Ryn types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Ryn assemblies aren't investigated (e.g. by not including something like "^Ryn|..." you may break core functionality.</remarks>
