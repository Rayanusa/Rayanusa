...
namespace Ryn.Core.Configuration
{
    /// <summary>
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, IRynFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(RynConfigurationDefaults.AppSettingsFilePath);
