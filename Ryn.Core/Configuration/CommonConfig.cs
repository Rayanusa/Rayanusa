namespace Ryn.Core.Configuration
{
    ...
    public partial class CommonConfig : IConfig
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous RynCommerce versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousRyncommerceVersions { get; private set; } = true;
