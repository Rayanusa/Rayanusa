...
{
    public partial class CustomerValidator : BaseRynValidator<CustomerModel>
    {
        ...
        private async Task<bool> IsRegisteredCustomerRoleCheckedAsync(CustomerModel model, ICustomerService customerService)
        {
            ...
            var isInRegisteredRole = newCustomerRoles.FirstOrDefault(cr => cr.SystemName == RynCustomerDefaults.RegisteredRoleName) != null;
