...
using Ryn.Web.Areas.Admin.Models.Affiliates;
using Ryn.Web.Areas.Admin.Models.Blogs;
...
using Ryn.Web.Areas.Admin.Models.Logging;
using Ryn.Web.Areas.Admin.Models.Messages;
using Ryn.Web.Areas.Admin.Models.MultiFactorAuthentication;
using Ryn.Web.Areas.Admin.Models.News;
using Ryn.Web.Areas.Admin.Models.Orders;
using Ryn.Web.Areas.Admin.Models.Payments;
...
namespace Ryn.Web.Areas.Admin.Infrastructure.Mapper
{
    /// <summary>
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        public AdminMapperConfiguration()
        {
            ...
            {
                //exclude Form and CustomProperties from mapping BaseRynModel
                if (typeof(BaseRynModel).IsAssignableFrom(mapConfiguration.DestinationType))
                {
                    //map.ForMember(nameof(BaseRynModel.Form), options => options.Ignore());
                    map.ForMember(nameof(BaseRynModel.CustomProperties), options => options.Ignore());
                }
