    ...
    public partial class CategoryController : BaseAdminController
    {
        ...
        public virtual async Task<IActionResult> Edit(CategoryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    await _staticCacheManager.RemoveByPrefixAsync(RynCatalogDefaults.CategoriesByParentCategoryPrefix, category.ParentCategoryId);
                    await _staticCacheManager.RemoveByPrefixAsync(RynCatalogDefaults.CategoriesChildIdsPrefix, category.ParentCategoryId);
                }
