...
using Ryn.Services.ExportImport;
...
using Ryn.Web.Framework.Controllers;
using Ryn.Web.Framework.Mvc;
using Ryn.Web.Framework.Mvc.Filters;
...
namespace Ryn.Web.Areas.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
        ...
        protected virtual async Task<string> ValidateCustomerRolesAsync(IList<CustomerRole> customerRoles, IList<CustomerRole> existingCustomerRoles)
        {
            ...
            if (rolesToAdd.Any(role => role.SystemName != RynCustomerDefaults.RegisteredRoleName) || rolesToDelete.Any())
            {
            ...
            var isInGuestsRole = customerRoles.FirstOrDefault(cr => cr.SystemName == RynCustomerDefaults.GuestsRoleName) != null;
            var isInRegisteredRole = customerRoles.FirstOrDefault(cr => cr.SystemName == RynCustomerDefaults.RegisteredRoleName) != null;
        ...
        protected virtual async Task<string> ParseCustomCustomerAttributesAsync(IFormCollection form)
        {
            ...
            {
                var controlId = $"{RynCustomerServicesDefaults.CustomerAttributePrefix}{attribute.Id}";
        ...
        {
            var customers = await _customerService.GetAllCustomersAsync(customerRoleIds: new[] { (await _customerService.GetCustomerRoleBySystemNameAsync(RynCustomerDefaults.AdministratorsRoleName)).Id });
        ...
        public virtual async Task<IActionResult> Create(CustomerModel model, bool continueEditing, IFormCollection form)
        {
            ...
            if (newCustomerRoles.Any() && newCustomerRoles.FirstOrDefault(c => c.SystemName == RynCustomerDefaults.RegisteredRoleName) != null &&
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_dateTimeSettings.AllowCustomersToSetTimeZone)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.TimeZoneIdAttribute, model.TimeZoneId);
                if (_customerSettings.GenderEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.GenderAttribute, model.Gender);
                if (_customerSettings.FirstNameEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.FirstNameAttribute, model.FirstName);
                if (_customerSettings.LastNameEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.LastNameAttribute, model.LastName);
                if (_customerSettings.DateOfBirthEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.DateOfBirthAttribute, model.DateOfBirth);
                if (_customerSettings.CompanyEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.CompanyAttribute, model.Company);
                if (_customerSettings.StreetAddressEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.StreetAddressAttribute, model.StreetAddress);
                if (_customerSettings.StreetAddress2Enabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.StreetAddress2Attribute, model.StreetAddress2);
                if (_customerSettings.ZipPostalCodeEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.ZipPostalCodeAttribute, model.ZipPostalCode);
                if (_customerSettings.CityEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.CityAttribute, model.City);
                if (_customerSettings.CountyEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.CountyAttribute, model.County);
                if (_customerSettings.CountryEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.CountryIdAttribute, model.CountryId);
                if (_customerSettings.CountryEnabled && _customerSettings.StateProvinceEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.StateProvinceIdAttribute, model.StateProvinceId);
                if (_customerSettings.PhoneEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.PhoneAttribute, model.Phone);
                if (_customerSettings.FaxEnabled)
                    await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.FaxAttribute, model.Fax);

                //custom customer attributes
                await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.CustomCustomerAttributes, customerAttributesXml);
                ...
                foreach (var customerRole in newCustomerRoles)
                {
                    ...
                    if (customerRole.SystemName == RynCustomerDefaults.AdministratorsRoleName && !await _customerService.IsAdminAsync(await _workContext.GetCurrentCustomerAsync()))
                        continue;
                ...
                {
                    var vendorRole = await _customerService.GetCustomerRoleBySystemNameAsync(RynCustomerDefaults.VendorsRoleName);
        ...
        public virtual async Task<IActionResult> Edit(CustomerModel model, bool continueEditing, IFormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        var prevVatNumber = await _genericAttributeService.GetAttributeAsync<string>(customer, RynCustomerDefaults.VatNumberAttribute);

                        await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.VatNumberAttribute, model.VatNumber);
                        ...
                        if (!string.IsNullOrEmpty(model.VatNumber))
                        {
                            if (!model.VatNumber.Equals(prevVatNumber, StringComparison.InvariantCultureIgnoreCase))
                            {
                                await _genericAttributeService.SaveAttributeAsync(customer,
                                    RynCustomerDefaults.VatNumberStatusIdAttribute,
                    ...
                    foreach (var customerRole in allCustomerRoles)
                    {
                        ...
                        if (customerRole.SystemName == RynCustomerDefaults.AdministratorsRoleName &&
                        ...
                        else
                        {
                            ...
                            if (customerRole.SystemName == RynCustomerDefaults.AdministratorsRoleName && !await SecondAdminAccountExistsAsync(customer))
                            {
        ...
        public virtual async Task<IActionResult> RemoveBindMFA(int id)
        {
            ...
            await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.SelectedMultiFactorAuthenticationProviderAttribute, string.Empty);
        ...
        public virtual async Task<IActionResult> Impersonate(int id)
        {
            ...
            await _customerService.UpdateCustomerAsync(customer);
            await _genericAttributeService.SaveAttributeAsync<int?>(currentCustomer, RynCustomerDefaults.ImpersonatedCustomerIdAttribute, customer.Id);
        ...
        public virtual async Task<IActionResult> ReSendActivationMessage(CustomerModel model)
        {
            ...
            await _genericAttributeService.SaveAttributeAsync(customer, RynCustomerDefaults.AccountActivationTokenAttribute, Guid.NewGuid().ToString());
        ...
        public virtual async Task<IActionResult> SendEmail(CustomerModel model)
        {
            ...
            try
            {
                if (string.IsNullOrWhiteSpace(customer.Email))
                    throw new RynException("Customer email is empty");
                if (!CommonHelper.IsValidEmail(customer.Email))
                    throw new RynException("Customer email is not valid");
                if (string.IsNullOrWhiteSpace(model.SendEmail.Subject))
                    throw new RynException("Email subject is empty");
                if (string.IsNullOrWhiteSpace(model.SendEmail.Body))
                    throw new RynException("Email body is empty");

                var emailAccount = await _emailAccountService.GetEmailAccountByIdAsync(_emailAccountSettings.DefaultEmailAccountId);
                if (emailAccount == null)
                    emailAccount = (await _emailAccountService.GetAllEmailAccountsAsync()).FirstOrDefault();
                if (emailAccount == null)
                    throw new RynException("Email account can't be loaded");
        ...
        public virtual async Task<IActionResult> SendPm(CustomerModel model)
        {
            ...
            try
            {
                if (!_forumSettings.AllowPrivateMessages)
                    throw new RynException("Private messages are disabled");
                if (await _customerService.IsGuestAsync(customer))
                    throw new RynException("Customer should be registered");
                if (string.IsNullOrWhiteSpace(model.SendPm.Subject))
                    throw new RynException(await _localizationService.GetResourceAsync("PrivateMessages.SubjectCannotBeEmpty"));
                if (string.IsNullOrWhiteSpace(model.SendPm.Message))
                    throw new RynException(await _localizationService.GetResourceAsync("PrivateMessages.MessageCannotBeEmpty"));
        ...
        public virtual async Task<IActionResult> LoadCustomerStatistics(string period)
        {
            ...
            var searchCustomerRoleIds = new[] { (await _customerService.GetCustomerRoleBySystemNameAsync(RynCustomerDefaults.RegisteredRoleName)).Id };
