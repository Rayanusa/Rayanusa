...
namespace Ryn.Web.Areas.Admin.Models.Catalog
{
    ...
    public partial record ProductSearchModel : BaseSearchModel
    {
        ...
        [RynResourceDisplayName("Admin.Catalog.Products.List.SearchIncludeSubCategories")]
        ...
        [RynResourceDisplayName("Admin.Catalog.Products.List.SearchPublished")]
        public int SearchPublishedId { get; set; }

        [RynResourceDisplayName("Admin.Catalog.Products.List.GoDirectlyToSku")]
