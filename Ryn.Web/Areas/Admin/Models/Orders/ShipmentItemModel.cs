...
namespace Ryn.Web.Areas.Admin.Models.Orders
{
    ...
    /// </summary>
    public partial record ShipmentItemModel : BaseRynEntityModel
    {
        #region Ctor
        ...
        [RynResourceDisplayName("Admin.Orders.Shipments.Products.ProductName")]
        ...
        [RynResourceDisplayName("Admin.Orders.Shipments.Products.ItemWeight")]
        public string ItemWeight { get; set; }

        [RynResourceDisplayName("Admin.Orders.Shipments.Products.ItemDimensions")]
        ...
        [RynResourceDisplayName("Admin.Orders.Shipments.Products.QtyShipped")]
        ...
        public record WarehouseInfo : BaseRynModel
        {
