...
namespace Ryn.Web.Areas.Admin.Models.Orders
{
    ...
    public record ReturnRequestSearchModel: BaseSearchModel
    {
        ...
        [RynResourceDisplayName("Admin.ReturnRequests.SearchStartDate")]
        [UIHint("DateNullable")]
        public DateTime? StartDate { get; set; }

        [RynResourceDisplayName("Admin.ReturnRequests.SearchEndDate")]
        [UIHint("DateNullable")]
        public DateTime? EndDate { get; set; }

        [RynResourceDisplayName("Admin.ReturnRequests.SearchCustomNumber")]
        public string CustomNumber { get; set; }

        [RynResourceDisplayName("Admin.ReturnRequests.SearchReturnRequestStatus")]
