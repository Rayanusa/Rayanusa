...
using Ryn.Services.Plugins.Marketplace;
...
namespace Ryn.Web.Areas.Admin.Factories
{
    ...
    public partial class PluginModelFactory : IPluginModelFactory
    {
        ...
        public virtual async Task<OfficialFeedPluginSearchModel> PrepareOfficialFeedPluginSearchModelAsync(OfficialFeedPluginSearchModel searchModel)
        {
            ...
            var currentVersionItem = searchModel.AvailableVersions.FirstOrDefault(x => x.Text.Contains(RynVersion.CURRENT_VERSION));
        ...
        public virtual async Task<IList<AdminNavigationPluginModel>> PrepareAdminNavigationPluginModelsAsync()
        {
            ...
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(RynPluginDefaults.AdminNavigationPluginsCacheKey, customer);
