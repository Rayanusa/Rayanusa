...
namespace Ryn.Web.Areas.Admin.Models.Localization
{
    ...
    public partial record LocaleResourceSearchModel : BaseSearchModel
    {
        ...
        [RynResourceDisplayName("Admin.Configuration.Languages.Resources.SearchResourceName")]
        public string SearchResourceName { get; set; }

        [RynResourceDisplayName("Admin.Configuration.Languages.Resources.SearchResourceValue")]
