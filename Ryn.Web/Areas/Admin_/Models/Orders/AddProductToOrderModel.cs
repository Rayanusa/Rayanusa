...
namespace Ryn.Web.Areas.Admin.Models.Orders
{
    ...
    /// </summary>
    public partial record AddProductToOrderModel : BaseRynModel
    {
        #region Ctor
        ...
        [RynResourceDisplayName("Admin.Orders.Products.AddNew.UnitPriceInclTax")]
        public decimal UnitPriceInclTax { get; set; }
        [RynResourceDisplayName("Admin.Orders.Products.AddNew.UnitPriceExclTax")]
        public decimal UnitPriceExclTax { get; set; }

        [RynResourceDisplayName("Admin.Orders.Products.AddNew.Quantity")]
        public int Quantity { get; set; }

        [RynResourceDisplayName("Admin.Orders.Products.AddNew.SubTotalInclTax")]
        public decimal SubTotalInclTax { get; set; }
        [RynResourceDisplayName("Admin.Orders.Products.AddNew.SubTotalExclTax")]
        ...
        public partial record GiftCardModel : BaseRynModel
        {
