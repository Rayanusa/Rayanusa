...
using Ryn.Core.Infrastructure.Mapper;
using Ryn.Services.Plugins;
using Ryn.Web.Framework.Models;

namespace Ryn.Web.Areas.Admin.Infrastructure.Mapper.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BaseRynEntityModel
        {
            if (entity == null)
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : BaseEntity where TModel : BaseRynEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseRynEntityModel model) where TEntity : BaseEntity
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseRynModel, ISettingsModel
        {
            if (settings == null)
        ...
        public static TSettings ToSettings<TSettings, TModel>(this TModel model, TSettings settings)
            where TSettings : class, ISettings where TModel : BaseRynModel, ISettingsModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToConfigModel<TModel>(this IConfig config) where TModel : BaseRynModel, IConfigModel
        {
            if (config == null)
        ...
        public static TConfig ToConfig<TConfig, TModel>(this TModel model, TConfig config)
            where TConfig : class, IConfig where TModel : BaseRynModel, IConfigModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToPluginModel<TModel>(this IPlugin plugin) where TModel : BaseRynModel, IPluginModel
        {
            if (plugin == null)
        ...
        public static TModel ToPluginModel<TModel>(this PluginDescriptor pluginDescriptor, TModel model = null)
            where TModel : BaseRynModel, IPluginModel
        {
