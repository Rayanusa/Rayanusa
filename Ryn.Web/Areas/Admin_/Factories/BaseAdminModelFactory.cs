...
namespace Ryn.Web.Areas.Admin.Factories
{
    ...
    public partial class BaseAdminModelFactory : IBaseAdminModelFactory
    {
        ...
        {
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(RynModelCacheDefaults.CategoriesListKey, showHidden);
        ...
        {
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(RynModelCacheDefaults.ManufacturersListKey, showHidden);
            var listItems = await _staticCacheManager.GetAsync(cacheKey, async () =>
            {
        ...
        {
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(RynModelCacheDefaults.VendorsListKey, showHidden);
            var listItems = await _staticCacheManager.GetAsync(cacheKey, async () =>
            {
